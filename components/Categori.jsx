...
export default function Categori() {
  const categories = [
    { name: "Electronics", icon: Smartphone, color: "text-blue-600", bg: "bg-blue-50" },
    { name: "Fashion", icon: Shirt, color: "text-rose-600", bg: "bg-rose-50" },
    { name: "Home & Garden", icon: Home, color: "text-emerald-600", bg: "bg-emerald-50" },
    { name: "Sports", icon: Trophy, color: "text-amber-600", bg: "bg-amber-50" },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                {/* আইকন কন্টেইনার */}
                <div className={`mb-6 p-4 rounded-xl ${cat.bg} ${cat.color} group-hover:scale-110 transition-transform duration-300`}>
