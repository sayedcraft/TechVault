...
export default function Testimonial() {
  const testimonials = [
    {
      name: "Sarah Johnson",
      comment: "Amazing quality products and fast shipping! Highly recommend ShopHub for online shopping.",
      rating: 5,
      initials: "SJ",
      role: "Verified Buyer"
    },
    {
      name: "Mike Chen",
      comment: "Best shopping experience ever. The customer service is excellent and super responsive!",
      rating: 5,
      initials: "MC",
      role: "Loyal Customer"
    },
    {
      name: "Emma Wilson",
      comment: "Great prices and easy returns. Will definitely shop here again for my family!",
      rating: 5,
      initials: "EW",
      role: "Verified Buyer"
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-500 font-medium">
            Join thousands of satisfied customers worldwide who trust ShopHub everyday.
          </p>
        </div>
